...
import com.skynet.chovietship.ui.contact.ContactUsActivity;
import com.skynet.chovietship.ui.history.ListHistoryActivity;
import com.skynet.chovietship.ui.listchat.ListChatActivity;
import com.skynet.chovietship.ui.news.NotificationActivity;
...
//                    getDrawable(R.drawable.seletor_category), null, null);
        ...
        if (profile.getActive() != 1) {
            startActivity(new Intent(MainActivity.this, StatusAccountActivity.class));
            finish();
            return;
