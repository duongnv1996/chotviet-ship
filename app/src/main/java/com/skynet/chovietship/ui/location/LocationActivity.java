...
import com.skynet.chovietship.ui.category.listProductbylocation.ListProductActivity;
import com.skynet.chovietship.ui.market.ListMarketActivity;
...
//        getWindow().setExitTransition(new Explode());
    ...
    public void onViewClicked() {
        Intent intent;
        if (getIntent().getStringExtra("name") != null && getIntent().getStringExtra("name").toLowerCase().equals("đi chợ")) {
            intent = new Intent(this, ListMarketActivity.class);
        } else {
