package com.skynet.chovietship.ui;
...
public class FCMService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            if (data != null) {
                com.skynet.chovietship.models.Notification notification = new Gson().fromJson(data, com.skynet.chovietship.models.Notification.class);
