...
//        tabLayout.setupWithViewPager(viewpager);
    ...
    public void onRefresh() {
        String id  = getIntent().getStringExtra(AppConstant.MSG);
        if(id == null || id.isEmpty()){
            id = String.valueOf(getIntent().getIntExtra(AppConstant.MSG,0));
        }
...
//        shareIntent.putExtra(Intent.EXTRA_TEXT, "http://Choviet.vn/shop_detail.php?id="+shopDetail.getShop().getId());
